...
class SealGPT_Sep(nn.Module, Base):
    def __init__(self, input_channels=1, output_channels=2, n_mel=128, dprnn=True, dprnn_layers=2, dprnn_hidden=128, momentum=0.01):
