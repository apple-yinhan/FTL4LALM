...
class AFWhisperEncoder(Qwen2AudioPreTrainedModel):
    ...
    def __init__(self, config: Qwen2AudioEncoderConfig, **kwargs):
    ...
    @torch.no_grad() # To freeze the params
    def forward(
        self,
        input_features,
        attention_mask=None,
        ...
        # print( 'af whisper input:', input_features.shape, attention_mask.shape, head_mask, output_attentions, output_hidden_states, return_dict)
        # af whisper input: torch.Size([1, 128, 3000]) torch.Size([1, 1, 1500, 1500]) None None None None
